...
import java.util.Map;
	...
	public class FacialRecognitionActivity extends Activity {
		...
		//LiveRecognition bc2=new LiveRecognition();
		...
		/*private static final String LOGIN_URL = "http://www.13bpsrhostzi.com/index.php";    //url of your php file
		...
		ActionBar a;
*/
	    /*public void jsonconnect(String username) {
		pDialog = new ProgressDialog(this);
		pDialog.setMessage("Attence_Status-present");
...
/*		JSONObject jobj = new JSONObject();
		...
		JsonObjectRequest req = new JsonObjectRequest(LOGIN_URL, jobj,
				new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
						try {
							...
							Toast.makeText(FacialRecognitionActivity.this, msg, Toast.LENGTH_SHORT).show();
						} catch (JSONException e) {
							e.printStackTrace();
						}
			...
			public void onErrorResponse(VolleyError error) {
				...
				Toast.makeText(FacialRecognitionActivity.this,"Some Connection error maybe", Toast.LENGTH_SHORT).show();
