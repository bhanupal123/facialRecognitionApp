...
public class ImageConfirmation extends Activity {
	...
	private String LOGIN_URL = "13bpsr.hostzi.com/index.php";
	...
	String c;
	//FacialRecognitionActivity bc=new FacialRecognitionActivity();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		mQueue = com.qualcomm.snapdragon.sdk.recognition.sample.CustomVolleyRequestQueue.getInstance(ImageConfirmation.this)
				.getRequestQueue();
	...
	private void volleyconnect(){
		...
		JsonObjectRequest req = new JsonObjectRequest(LOGIN_URL, new JSONObject(params),
			...
			public void onErrorResponse(VolleyError error) {
				...
				pDialog.dismiss();
				Toast.makeText(ImageConfirmation.this,"Network Error", Toast.LENGTH_SHORT).show();
			}
		});
		mQueue.add(req);
	}
